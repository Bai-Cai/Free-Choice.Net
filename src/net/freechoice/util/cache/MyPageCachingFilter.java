package net.freechoice.util.cache;
 ...
 *
 */
public class MyPageCachingFilter extends SimplePageCachingFilter {
	
	private final static Logger log = Logger.getLogger(MyPageCachingFilter.class);
